...
class LearningSession:
    ...
    async def start(self, workspace_root: str = "") -> dict:
        ...
        self.codex.set_system_prompt(
            ...
            "搜索工具支持 subject_id 学科过滤；当用户问题明显属于某个学科时应按学科路由："
            "数学关键词包括高数/线代/概率/极限/导数/积分/矩阵；"
            "408计算机关键词包括数据结构/计组/OS/计网/二叉树/链表/排序/进程/内存；"
            "英语关键词包括阅读/作文/翻译/完形/词汇；政治关键词包括马原/毛概/史纲/思修/时政。"
            "如果无法判断学科或同时涉及多个学科，不要强行限定，退化为全库搜索。"
            "所有回复必须使用中文，禁止使用英文回复。"
